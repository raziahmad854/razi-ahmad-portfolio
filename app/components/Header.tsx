...
const Header = () => {
  ...
  return (
    ...
    >
      {/* FIXED: Container properly wraps content */}
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
          <div className="flex items-center justify-between h-14 sm:h-16 md:h-20">
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="flex-shrink-0 cursor-pointer min-w-0"
              onClick={() => handleNavClick('hero')}
            >
              <span className="text-xl sm:text-2xl font-bold gradient-text">RA</span>
            </motion.div>
            ...
            <div className="hidden md:flex">
              ...
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  className="text-gray-700 dark:text-gray-300 hover:text-primary-600 dark:hover:text-primary-400 px-2 lg:px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200"
                >
                  {item.label}
                </motion.button>
              ))}
